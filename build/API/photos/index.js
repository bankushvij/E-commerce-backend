...
var _s3Config = require("../../utils/s3.config.js");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return (0, _s3Config.s3upload)(bucketOptions);

          case 5:
            uploadImage = _context.sent;
            _context.next = 8;
            return _allmodels.photosModel.create({
              images: [{
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _id = req.params._id;
            _context2.next = 4;
            return _allmodels.photosModel.findById(_id);
