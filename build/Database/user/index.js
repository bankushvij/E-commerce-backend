...
UserSchema.statics.findByEmailandPassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref3) {
    var email, password, user, doesPaswordMatch;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            doesPaswordMatch = _context2.sent;
...
UserSchema.pre("save", function (next) {
  ...
  var user = this; // next function is called when we are done with our pre function 

  if (!user.isModified("password")) return next(); // generating the salt 

  _bcryptjs["default"].genSalt(8, function (error, salt) {
    // if error available return then
    if (error) return next(error); // generating the hash 
